ui.module('framework').add('introduce', {
    i18n: ui.i18n('zh', {
        ...
        '传统开发方式在存量上保有一定的惯性，jQuery在某些场景下也是最佳选择，浏览器的更新虽没太激进，但兼容性问题基本上解决了，jQuery能满足兼容性的需求消失了。' +
        '此外三大框架较为完整和统一的UI组件库，在效果上也更为美观协调，直接吸引了视觉设计师和产品经理的选择。趋势是在更迭的，过程也不是必须和激烈的，只是从jQuery官方保守的态度来说，jQuery技术栈要有接受被淘汰的准备。</p>' +
        '</section>' +
        ...
        '</section>' +
        '<header>个人觉得jQuery应该增强这四点：</header>' +
        '<section>' +
        '<ul>' +
