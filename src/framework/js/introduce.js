        ...
        'framework-introduce-content': function () {
            return [
                ui('article').block({
                    header: '丑话写在前头',
                    content: [
                        '<p>本人投身前端开发大于7年，一直工作在技术岗位第一线，至今仍未有机会和能力走向管理岗位，苦于业务，坑于造轮子，没有进过大厂，也未能带好小团队，技术涉猎面交小，缺少设计模式经验，缺少与大神交流的经验。</p>',
                        '<p>本框架的设计产出实属开发总结，一家之谈且较为碎片化，本意尽量做到中肯表述，如有词不达意，高谈阔论的地方还请海涵。虽有较多原创特性，但仍未经过多项项目验证，不建议其他人将其用于生产环境，欢迎讨论交流，推动框架走向成熟。</p>',
                    ]
                }),
                ui('article').block({
                    header: '投石问路，抛砖引玉',
