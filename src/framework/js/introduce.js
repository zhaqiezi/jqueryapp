    ...
    i18n: ui.i18n('zh', {
        ...
        'framework-introduce-content': function () {
            return [
                ...
                ui('article').block({
                    header: '个人觉得jQuery应该增强这四点：',
                    list: [
                        '基于Nodejs开发，使用相关工具',
                        '基于视觉和交互来开发UI组件化，需美观且高复用性',
                ...
                ui('article').block({
                    ...
                    content: [
                        '<p>立足前端开发的的基本工作，为了能更好地开发出符合需求的网页，我们建议从项目立项，方案选型，技术预演，开发测试都应该遵循一定的设计规范，明确评审指标，需求方和开发方才能建立稳固的沟通基础，认同现有的开发结果，清晰未来的开发计划。</p>',
                        '<p>jQueryApp协助实现这一良性的开发循环，从交互理论，代码效率，网络加载，页面性能等方面提供可参考的数据，预期达到项目的产出有：</p>',
                        ui('article').block({
                            list: [
                                '丰富的界面表现层',
                                '简洁的代码逻辑层',
                        ...
                        '<p>jQueryApp秉承jQuery工具化的理念，尽量明确每个功能，每个对象的输入，输出，初始化，赋值，取值，回调等重要环节，继续彰显<label class="font green">write less do more</label> 的澎湃活力。</p>',
                    ]
                }),
