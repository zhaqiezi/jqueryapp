ui.module('framework').add('introduce', {
    i18n: ui.i18n('zh', {
        ...
        '<p class="font blue f18">我个人觉得原因有三条</p>' +
        ...
        '<p>其二是使用者主动放弃的原因：jQuery的选择器效率高，事件绑定方便，自身对象可与DOM对象无缝转换，还有其他特性优良，语法简洁的API，更重要的是对浏览器的兼容性好，对插件的扩展性也好，这样其他功能的插件便在jQuery的基础上百花齐放。' +
        '优点有时候也会成为缺点，从使用者的角度看，存在标准的问题，单就jQuery核心说，因为有官方团队在维护，所以API标准是存在的，但插件就不一样了，存在选择困难，社区活跃，人人都可以潜心学习然后造一套轮子，含一种设计模式，一种API接口模式，' +
        '插件的品质有赖于个人开发者的水平和能否持续地维护。前端开发者往往准备一套满意的UI库是需要几种独立的插件组，这对开发者和团队来说，组件标准不一，记忆成本大，跨项目跨团队合作时问题突显。</p>' +
        '<p>其三是时代的不可抗力：学习的经验告诉每个开发者都应该去尝试新的东西，接受旧事物的消亡，加上一些商业推文的影响，技术栈就这样发生着更迭。基于Nodejs的开发方式，至少在前端工具上表现出来的高效率是无法拒绝的，传统开发方式在存量上保有一定的惯性，' +
        '浏览器的更新也没太激进，新模式在实际应用中受到一些传统指标的影响（比如js包的大小），加上一些个人品味（比如我就是热爱jQuery），更迭也不是必须的和激烈的，只是从jQuery官方保守的态度来说，要有接受被淘汰的准备。</p>' +
